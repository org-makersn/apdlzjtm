...
//            if (start != "" && end != "")
//            {
//                query += string.Format(" AND REQ.REG_DT >= '{0}' AND  REQ.REG_DT < '{1} 23:59:59' ", start, end);
//            }

//            if (state != 0)
//            {
//                query += string.Format(" AND REQ.ORDER_STATUS = '{0}'", state);
//            }

//            if (text != "")
//            {
//                query += string.Format(" AND (M.NAME LIKE '%{0}%' OR PM.NAME LIKE '%{0}%') ", text);
//            }
...
//            {
//                return session.CreateSQLQuery(query).AddEntity(typeof(PrinterStateT)).List<PrinterStateT>();
//            }
//        }
