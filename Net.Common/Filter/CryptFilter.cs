...
namespace Net.Common.Filter
{
    public static class CryptFilter
    {
        ...
        public static string RSAEncrypt(string sValue, string sPubKey)
        {
            ...
            RSACryptoServiceProvider oEnc = new RSACryptoServiceProvider(); //암호화
        ...
        public static string RSADecrypt(string sValue, string sPrvKey)
        {
            ...
            //RSA객체생성
            RSACryptoServiceProvider oDec = new RSACryptoServiceProvider(); //복호화
            //개인키로 활성화
        ...
        {
            return DesEncrypt(inStr, EncryptionKey);
        }
        ...
        {
            return DesDecrypt(inStr, EncryptionKey);
        }
