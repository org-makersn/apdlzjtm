...
namespace Net.Framework.Util
{
    ...
    public class EnumHelper
    {
        ...
        /// <param name="exceptTypes">排除的枚举</param>
        /// <returns></returns>
        public static Dictionary<string, string> GetEnumDictionaryT<TEnum>(IEnumerable<TEnum> exceptTypes = null) where TEnum : struct
        {
            var dic = GetItemList<TEnum>();
            ...
            foreach (var d in dic)
            {
                ...
                dicNew.Add(d.Key.ToString(), d.Value);
            }
            return dicNew;
        }
    }
